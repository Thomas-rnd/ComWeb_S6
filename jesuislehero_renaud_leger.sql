...
--
-- Hôte : localhost:8889
-- Généré le : ven. 06 mai 2022 à 06:59
...
--
ALTER TABLE `choix`
  MODIFY `CH_NUM` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;

--
-- AUTO_INCREMENT pour la table `histoire`
--
ALTER TABLE `histoire`
  MODIFY `HIST_NUM` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT pour la table `narration`
--
ALTER TABLE `narration`
  MODIFY `NARR_INDEX` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
